...
async def admin_actions(query, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if data == "admin_reset_autumn":
        ...
        return
    # Клановые админ-команды удалены
...
#   Кланы — удалено
# ----------------------------------------------------------------------
# Все функции и обработчики кланов удалены, ссылки на них в меню и коллбеках тоже удалены.
...
def main() -> None:
    ...
    # Проверка клановых битв удалена
